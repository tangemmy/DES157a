(function(){
    ...
    const gameData = {
        ...
        attackMessage: [
            'That was as good as a screen door on a submarine![-5 health]',
            'As effective as swatting each other with a net[-15 health]',
            'YOUCH! Like a wasp sting.[-25 health]',
            'Looks like theres a new scorpion in town[-30 health]',
            'One of us aint making it out of this island alive [-40 health]'
        ],
		defendMessage: [
            'I miss my mommy..[full hit]', 
            'Try a little harder next time, [partial hit]', 
            "HA you're gonna have to do better than that you dingbat!, [no hit!]"
        ],
		index: 0
	};
